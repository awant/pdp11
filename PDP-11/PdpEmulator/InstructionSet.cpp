...
std::string InstructionSet::GetInstructionString(int number) {
	std::string result = names[number] + " ";
...
std::string InstructionSet::getOperandString(word mode, word number) {
	switch (mode) {
	case 0:
